...
def train_and_evaluate_model(folder, train_path, valid_path):
    ...
    predictions_df.to_csv(os.path.join(folder, 'classification/result_num_rf.csv'), index=False)
    ...
    conf_matrix_df.to_csv(os.path.join(folder, 'confusion_matrix_num_rf.csv'))
